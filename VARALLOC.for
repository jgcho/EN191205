...
C  
      ...
      ALLOCATE(IAP(KPCM))  
C      ALLOCATE(IBENMAP(LCMWQ,2))    !{ GEOSR BENTHIC FLUX FOR ANOXIC ENV : YSSONG 2015.09.08
      ALLOCATE(IBENMAP(LCMWQ,3))     !{ GEOSR BENTHIC FLUX FOR ANOXIC ENV : YSSONG 2015.09.08
...
! { GEOSR GATE : JGCHO 2010.5.7
      ...
      ALLOCATE(CG6(NGTYPEM))          ! GEOSR UNG 2014.10.30
      ALLOCATE(CG7(NGTYPEM))          ! GEOSR UNG 2014.10.30
      ALLOCATE(CG8(NGTYPEM))          ! GEOSR UNG 2014.10.30
      ALLOCATE(CGH1(NGTYPEM))         ! GEOSR UNG 2014.10.30
      ALLOCATE(CGH2(NGTYPEM))         ! GEOSR UNG 2014.10.30
...
C
      ALLOCATE(CDDN(LCM)) ! GeoSR, 2014.07.04 YSSONG, WIND DRAG COEFF.
...
!{ GEOSR X-species : jgcho 2015.09.16
...
!{ GEOSR X-species : jgcho 2015.09.25
      ...
      ALLOCATE(WQTDGPX(NWQTDM,NXSP)) ! GEOSR X-species : jgcho 2015.11.27
!} GEOSR X-species : jgcho 2015.09.25
...
!} GEOSR X-species : jgcho 2015.09.30
!{ GEOSR X-species : jgcho 2015.10.15
...
!{ READ GC4ADV.INP : jgcho 2019.11.15
      ALLOCATE(CG3H1(NGTYPEM),CG3H2(NGTYPEM))
      ALLOCATE(CG3C1(NGTYPEM),CG3C2(NGTYPEM))
      ALLOCATE(CG4H1(NGTYPEM),CG4H2(NGTYPEM))
      ALLOCATE(CG4C1(NGTYPEM),CG4C2(NGTYPEM))
      ALLOCATE(CG5H1(NGTYPEM),CG5H2(NGTYPEM))
      ALLOCATE(CG5C1(NGTYPEM),CG5C2(NGTYPEM))
      ALLOCATE(CG6H1(NGTYPEM),CG6H2(NGTYPEM))
      ALLOCATE(CG6C1(NGTYPEM),CG6C2(NGTYPEM))
      ALLOCATE(CG7H1(NGTYPEM),CG7H2(NGTYPEM))
      ALLOCATE(CG7C1(NGTYPEM),CG7C2(NGTYPEM))
      ALLOCATE(CG8H1(NGTYPEM),CG8H2(NGTYPEM))
      ALLOCATE(CG8C1(NGTYPEM),CG8C2(NGTYPEM))
!} READ GC4ADV.INP : jgcho 2019.11.15
      RETURN  
      END  
