...
C
!{GeoSR, YSSONG, GROWTH LIMIT PRINT, 111031, 2015.12.10 SPATIAL DISTRIBUTION OF LIMITATION 
!        IF(ISCOMP .GT. 0)THEN
...
!}
        ...
        ENDIF              
        IF(ISCOMP .EQ. 1. OR. ISCOMP .EQ. 4)THEN
!}GeoSR, YSSONG, GROWTH LIMIT PRINT, 2015.12.10
          OPEN(3,FILE='WQDOCOMP.BIN',FORM='UNFORMATTED',
     &          POSITION='APPEND',STATUS='UNKNOWN')  
C          NREC3 = NREC3 + 1
          TIMTMP = TIMESUM3 / NWQCNT
          WRITE(3) N,TIMTMP
!{GeoSR, JHLEE, X-species GROWTH LIMIT PRINT, 160217
          IF(NXSP.GT.0) THEN
