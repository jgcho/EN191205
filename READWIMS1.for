...
! } GEOSR 2011.6.9 JGCHO END DAY CHECK
	...
	NPTXLDS=EVDAY                             ! JULIAN DATE, YSSONG 170906
	NPTXLDE=EVDAY+FLOAT(ITXPRD)/1440.         ! JULIAN DATE, YSSONG 170906 (ITXPRD : MIN -> DATE CONVERSION)
...
!}
        ...
        ENDDO
        WRITE(21,8898)
        WRITE(21,8991) ' 0.000000',(TXMASS0(K),K=1,KC)
        WRITE(21,8992) NPTXLDS-0.00001,(TXMASS0(K),K=1,KC)
        WRITE(21,8992) NPTXLDS,(TXMASS_3D(K),K=1,KC)
        WRITE(21,8992) NPTXLDE,(TXMASS_3D(K),K=1,KC)
        WRITE(21,8992) NPTXLDE+0.00001,(TXMASS0(K),K=1,KC)
        WRITE(21,8991) '   999.',(TXMASS0(K),K=1,KC)

 8899   FORMAT('C')
 8898   FORMAT('   0       6       86400.       0.       1.       0.')
         CLOSE(21)      
      ENDIF
 ...
 8992 FORMAT(F11.6,2X,<KC>(E11.4,1X))
 8991 FORMAT(A12,1X,<KC>(E11.4,1X))
