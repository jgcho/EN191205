...
!}
C
      INTEGER   IZA  ! GEOSR BENTHIC FLUX FOR ANOXIC ENV : YSSONG 2015.09.08
...
!}
!          if (K.eq.10) then
!      write(33,3301) N,WQVOX(134,10,1),WQVO(134,10,1),WQVX(134,10,1)
!     & ,WQV(134,10,1)
!      write(34,3301)N,WQKKX(134,1),WQKK(134),WQALSETX(134,10,1)
!     & ,WQBCSET(134,1)
!      write(35,3301)N,WQRRX(134,1),WQRR(134),WQACX(134),WQA1C
!      write(36,3301)N,WQPX(134,1),WQPC(134),WQPMX(1,1),WQPMC(1)
!      write(37,3301)N,WQKHNX(1),WQKHNC,WQTTX(1),WQTTC
!      write(38,3301)N,WQPNX(134,1),WQPNC(134),WQKHNX(1),WQKHNC
!      write(39,3301)N,WQKHPX(1),WQKHPC,WQOBTOT(134)
!      write(40,3301)N,WQPRX(134,1),WQPRC(134),WQPRRX(1,1),WQPRRC(1)
!      write(41,3301)N,WQBMX(134,1),WQBMC(134),WQBMRX(1,1),WQBMRC(1)
!      write(42,3301)N,WQTDRX(1,1),WQTDRC(1),XLIMTX(134,10,1)
!     & ,XLIMTC(134,10)
!      write(43,3301)N,WQF2IX(1),WQF2IC,WQFDX(1),WQFDC
!      write(44,3301)N,WQISX(1),WQISC,WQDOPX(1),WQDOPC
!      write(45,3301)N,WQF1NX(1),WQF1NC,WQGNX(1),WQGNC
!      write(46,3301)N,WQGPX(1),WQGPC
!          endif
 3301 format(i4,100e12.4)
        ELSE  
          DO L=2,LA  
            WQV(L,K,1)=WQVO(L,K,1)  
            WQVO(L,K,1) = WQVO(L,K,1)+WQV(L,K,1)  
