...
C      PARAMETER (CONV1=1.0E3,CONV2=8.64E4)  PMC Single Line
     ...
     &          XMRME  
      ...
      INTEGER   IZANOX,MDUM    !{ GEOSR BENTHIC FLUX FOR ANOXIC ENV : YSSONG 2015.09.08
      INTEGER   I,J,K
!{ GEOSR X-species : jgcho 2015.09.17
     ...
     &         ,WQKGPX2(NXSP)
      ...
      REAL      XWQVX(NXSP)                             ! C16 in WQ3DWC2.INP
!} GEOSR X-species : jgcho 2015.09.17
!{ GEOSR X-species : jgcho 2016.02.18
      CHARACTER*80 FLN
...
C     &    WQBFO2(1)          
     ...
     &      WQBFOXCOD(1,2),WQBFOXO2(1,2)  
      ENDIF
        DO L=2,LA  
C          WQBFPO4D(L)=WQBFPO4D(1)  
C          WQBFNH4(L)=WQBFNH4(1)  
C          WQBFNO3(L)=WQBFNO3(1)  
C          WQBFSAD(L)=WQBFSAD(1)  
C          WQBFCOD(L)=WQBFCOD(1)  
C          WQBFO2(L)=WQBFO2(1)  
...
!} GEOSR jgcho 2015.9.10
!{ GEOSR STOKES : YSSONG 2015.08.18 and jgcho 2015.9.10 Modified how to read
...
!     
     ...
     &             ,WQASCDX(i)
        WRITE(2,80)'* SILICA DISTRIBUTION COEFF FOR DIATOM PREDATION  '
        WRITE(2,81)' : (FSPPX, FSIPX)        = ', WQFSPPX(i),WQFSIPX(i)
        WRITE(2,80)'* SILICA DISTRIBUTION COEFF FOR DIATOM METABOLISM '
        WRITE(2,81)' : (FSPDX, FSIDX)        = ', WQFSPDX(i),WQFSIDX(i)
        WRITE(2,82)'*SILICA-TO-CARBON RATIO IN DIATOMS    = ',WQASCDX(i)
      enddo
!
! *** C14 WQ3DWC2.INP
!     
...
! *** C17-1 WQ3DWC2.INP
    ...
    !{ GEOSR X-species : jgcho 2015.10.13
     ...
     &            ,WQIRHALFX(i),WQCOEF1X(i),WQCOEF2X(i),WQCOEF3X(i)
      ...
      enddo
    !} GEOSR X-species : jgcho 2015.10.13
!{ GEOSR Light factor : jhlee 2016.07.20
! *** C17-2 WQ3DWC2.INP
      IF(ISSKIP .GT. 0) CALL SKIPCOMM(1,CCMRM)  
      IF(ISSKIP .EQ. 0) READ(1,*)  
...
!      CALL SEEK('C21')  
      ...
      DO M=1,IWQPS  
        ...
        ENDDO
      enddo
            !{ GEOSR X-species. specify Boundary series jgcho 2015.11.04
...
! *** C100 WQ3DWC2.INP
      ...
      !} GEOSR X-species : jgcho 2015.09.17
      close(1)
!} GEOSR and jgcho 2015.9.10 Modified how to read      
!
!
...
C  
        ...
        DO M=1,IJKC  
!{ GEOSR BENTHIC FLUX FOR ANOXIC ENV : YSSONG 2015.09.08
C          READ(1,*,END=1112) I, J, XMUD, IZMUD, IZSAND          !{ GEOSR BENTHIC FLUX FOR ANOXIC ENV : YSSONG 2015.09.08
...
!} GEOSR BENTHIC FLUX FOR ANOXIC ENV : YSSONG 2015.09.08          
          ...
          IBENMAP(L,1) = IZMUD  
          IBENMAP(L,2) = IZSAND  
          IF(IWQBENOX.NE.0) IBENMAP(L,3) = IZANOX                  !{ GEOSR BENTHIC FLUX FOR ANOXIC ENV : YSSONG 2015.09.08
