...
!{GeoSR, YSSONG, TOXIC, 101029
	  ...
	  INTEGER ITX
	  INTEGER JTX
	  REAL*8    NPTXLDS   ! GEOSR, JGCHO, TOXIC, 101207
	  REAL*8    NPTXLDE   ! GEOSR, JGCHO, TOXIC, 101207
      INTEGER ISTXD1ST
      INTEGER ISTXDCV
      INTEGER ISTXDCH
      INTEGER ISTXDCP
...
!{ GEOSR STOKES : YSSONG 2015.08.18
      REAL,ALLOCATABLE::WQALSETX(:,:,:) ! GEOSR X-species : jgcho 2015.10.13
...
!{ READ GC4ADV.INP : jgcho 2019.11.15
      LOGICAL LGC4
      REAL,ALLOCATABLE,DIMENSION(:)::CG3H1,CG3H2,CG3C1,CG3C2
      REAL,ALLOCATABLE,DIMENSION(:)::CG4H1,CG4H2,CG4C1,CG4C2
      REAL,ALLOCATABLE,DIMENSION(:)::CG5H1,CG5H2,CG5C1,CG5C2
      REAL,ALLOCATABLE,DIMENSION(:)::CG6H1,CG6H2,CG6C1,CG6C2
      REAL,ALLOCATABLE,DIMENSION(:)::CG7H1,CG7H2,CG7C1,CG7C2
      REAL,ALLOCATABLE,DIMENSION(:)::CG8H1,CG8H2,CG8C1,CG8C2
      INTEGER IGC4
      REAL GC4DAY
!} READ GC4ADV.INP : jgcho 2019.11.15
