...
!{ GEOSR Cyano Sed : jgcho 2016.08.10
      REAL,ALLOCATABLE,DIMENSION(:,:)::WQCSED
      INTEGER,ALLOCATABLE,DIMENSION(:)::iQSED
      REAL,ALLOCATABLE,DIMENSION(:)::TAUDC
      REAL,ALLOCATABLE,DIMENSION(:)::TAUEC
      REAL,ALLOCATABLE,DIMENSION(:)::ERC
      REAL,ALLOCATABLE,DIMENSION(:)::WQSEDALPH
      INTEGER::LQSED
!} GEOSR Cyano Sed : jgcho 2016.08.10
...
!{ GEOSR  Algal growth rate for VEL. : jgcho 2017.12.03
      REAL::WQTC  ! Not use
      REAL::WQVC  ! Not use
      INTEGER,ALLOCATABLE,DIMENSION(:)::ialv
      REAL,ALLOCATABLE,DIMENSION(:)::albeta
      REAL,ALLOCATABLE,DIMENSION(:)::alalph
!} GEOSR  Algal growth rate for VEL. : jgcho 2017.12.03
